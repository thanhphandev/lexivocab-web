...
export function DemoTextArea({ className }: DemoTextAreaProps) {
    ...
    return (
        <div className={`h-full flex flex-col items-center justify-center px-4 md:px-6 py-4 ${className || ''}`}>
            {/* Header */}
            <motion.div
            ...
            >
                <div className="rounded-2xl overflow-hidden shadow-2xl shadow-orange-500/10 border border-orange-100/50 bg-white">
                    ...
                    {/* Content Area */}
                    <div className="relative p-5 md:p-8 bg-white select-text">
                        ...
                        <article className="prose prose-slate max-w-none text-sm md:text-base leading-relaxed relative text-left">
