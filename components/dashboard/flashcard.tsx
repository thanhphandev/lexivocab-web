                    ...
                    >
                        <div className="flex flex-col h-full">
                            ...
                            <div className="space-y-6 flex-grow">
                                <div>
                                    <h3 className="text-sm font-medium text-muted-foreground mb-2 uppercase tracking-wider">Meaning</h3>
                                    <p className="text-lg text-foreground">
                                        {card.customMeaning || <span className="italic opacity-50">No meaning provided</span>}
                                    </p>
                                </div>

                                {card.contextSentence && (
                                    <div>
                                        <h3 className="text-sm font-medium text-muted-foreground mb-2 uppercase tracking-wider">Context</h3>
